...
Hovering over the nodes would give the WHO textual summary for the node
(Note that this functionality is omitted here for the full tree, to
allow a quick display).
