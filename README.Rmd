...
plot(h, hover_msg=F)
```
Hovering over the nodes would give the WHO textual summary for the node (Note that this functionality is omitted here for the full tree, to allow a quick display). 


More examples and details of usage can be found in the website article, with active hovering.
You might need to allow a short time (<20 secs?) for the article to load.
